...
import footer_thumb2 from "@/assets/images/resource/manpowergood.png"


const footer_content = {
  sm_info: "At SK Enterprises, our mission is to make clean, affordable, and sustainable energy accessible to every home, office, and industry.",
  ...
  title: "Get In Touch",
  address: "Main road mandi chowk Vikasnagar Dehradun Uttarakhand 248198",
  phone: "+91-8006666632",
  email: "contactusskenterprises@gmail.com",
  bootom_links: [
    'Privacy',
    'Term & Conditions',
          ...
          <div className="row">
            ...
            <div className="col-lg-3">
              <div className="footer-thumb wow animate__slideInDown">
                <Image src={footer_thumb2} alt="image-title" />
              </div>
            </div>
          </div>
